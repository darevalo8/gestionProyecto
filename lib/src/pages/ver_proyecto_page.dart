...
class _VerProyectoState extends State<VerProyecto> {
  ...
  Widget _buildTitle(Proyecto proyecto){
    return Container(
  ...
  Widget _buildCardFecha(Proyecto proyecto) {
    return Card(
  ...
  Widget _buildCardClient(Proyecto proyecto) {
    return Card(
          borderOnForeground: false,
          elevation: 10.0,
          color: Colors.transparent,
            ...
            child: Column(
              ...
              children: <Widget>[
                ...
                ListTile(
                  ...
                  trailing: Text(proyecto.cliente),
                  title: Text('Cliente'),
                )
              ]
            ),
  ...
  Widget _buildCardDescription(Proyecto proyecto) {
    return Card(
          borderOnForeground: false,
          elevation: 10.0,
          color: Colors.transparent,
  ...
  Widget _buildCardEstado(Proyecto proyecto) {
  ...
  Widget _buildCardFases(Proyecto proyecto) {
  ...
  Widget buildItems(Proyecto proyecto){
